                                ...
                                <div class="portlet light portlet-fit portlet-form bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-green sbold uppercase">Cập Nhật Tài Khoản</span>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-actions">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                    	<input type="hidden" name="xltaikhoan" value="updatetk">
                                                    	<input type="hidden" name="email_tk" value="<%=request.getParameter("email_tk")%>">
